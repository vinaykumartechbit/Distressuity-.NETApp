(function (angular, undefined) {
    ...
    createDirective(app, 'scrollGlue', bottom);
    createDirective(app, 'scrollGlueTop', top);
    createDirective(app, 'scrollGlueBottom', bottom);
    createDirective(app, 'scrollGlueLeft', left);
    createDirective(app, 'scrollGlueRight', right);
}(angular));
